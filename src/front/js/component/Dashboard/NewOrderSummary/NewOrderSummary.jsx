        ...
        <div id="new-order-summary-container">
            <div className="new-order-summary">
                <div className="new-order-summary-title">
                    ...
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-receipt-cutoff" viewBox="0 0 16 16">
                ...
                <div className="new-order-summary-item">
                    <div>
                        <p className="fw-bold">2px</p>
                        <p>
                            <strong>Plato 1</strong><br />
                            Descripción del plato 1
                        </p>
                    </div>
                ...
                <div className="new-order-summary-item">
                    <div>
                        <p className="fw-bold">1px</p>
                        <p>
                            <strong>Plato 2</strong><br />
                            Descripción del plato 2
                        </p>
                    </div>
                ...
                <div className="new-order-summary-item">
                    <div>
                        <p className="fw-bold">3px</p>
                        <p>
                            <strong>Plato 3</strong><br />
                            Descripción del plato 3
                        </p>
                    </div>
